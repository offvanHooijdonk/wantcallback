...
public class MaterialColorMapUtils {
    ...
    public int pickColorOnIdentifier(String identifier) {
        final int color = Math.abs(identifier.hashCode()) % sPrimaryColors.length();
        return sPrimaryColors.getColor(color, resources.getColor(
                R.color.quickcontact_default_photo_tint_color));
    }
    /**
